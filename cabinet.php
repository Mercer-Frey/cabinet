                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col l12 s12">
                            <p>
                                <label>
                                <input class="sex" name="sex" value="male" type="radio"/>
                                <span>Male</span>
                                </label>
                            </p>
                            <p>
                                <label>
                                <input class="sex" name="sex" value="female" type="radio" />
                                <span>Female</span>
                                </label>
                            </p>
                            <p>
                                <label>
                                <input class="sex with-gap" value="other" name="sex" type="radio"  />
                                <span>Other</span>
                                </label>
                            </p>
                        </div>
                        <div class="col l12 s12 right-align">
                            <button id="signup-submit" class="waves-effectwaves-light btn blue lighten-1">Update</button>
                        </div>
                    </div>
                </form>
            </div>    
